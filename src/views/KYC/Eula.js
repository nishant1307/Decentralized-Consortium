...
export default function Eula(props) {
    ...
    return (
      ...
      &amp; in his / her lawful possession at the time of submission.<br /><br />
          ...
          developed whereas some are work in progress.<br /><br />
      ...
      These EULA are in effect for all of our Digital Properties.<br /><br />
                These EULA are not applicable to any other web page operated and / or owned by any entity other than Arthanium, including, but not limited to, any website, mobile application, blog, forum, or other material operated by any third party identified on the Digital Properties.  When visiting these third-party websites, you should refer to the EULA and conditions in effect for the applicable owner.<br /><br />
                <strong>
                    Please read these EULA carefully, which include important information about your legal rights, remedies, and obligations.   By accessing or using the digital properties, you are entering into a legal contract with arthanium regarding your use of the digital properties.  By accessing or using the digital properties, you agree to be bound by the EULA and all additional EULA incorporated by reference.  If you do not agree to any portion of these EULA, you should not access or otherwise use the digital properties.
        </strong><br /><br />
                We will make an effort to update this web page with any changes to these EULA and you are encouraged to review these EULA frequently (the date of the most recent revision to these EULA appears at the end of these EULA).
                <br /><br />
                <strong>CONVENIENCE AND INFORMATION ONLY.</strong> The Digital Properties are provided to you as a convenience and for your information only. By merely providing access to the Digital Properties, we do not warrant or represent that: (a) any materials, documents, images, graphics, logos, design, audio, video and any other information provided from or on the Digital Properties (collectively, the “Content”) is accurate or complete; (b) the Content is up-to-date or current; (c) we have any obligation to update any Content; (d) the Content is free from technical inaccuracies or programming or typographical errors; (e) the Content is free from changes caused by a third party; (f) your access to the Digital Properties will be free from interruptions, errors, computer viruses or other harmful components; and/or (g) any information obtained in response to questions asked through the Digital Properties is accurate or complete.<br /><br />
...
<br /><br />
                ...
                <strong>(d) YOUR RESPONSIBILITIES. </strong>You are responsible for establishing such procedures as you deem appropriate to verify the accuracy of data transmitted hereunder (and we will have no obligation to verify the accuracy of such data).
                <br /><br />
 ...
 <br /><br />
                ...
                <li>
                    ...
                    <li>
                        A provider of content subject to a claim of infringement may make a counter notification. To file a counter notification with us, please provide the IT ACT 2010 Agent a written communication containing the following:
                    </li>
                    <li>
                        identification of the supposedly infringing material that is to be removed;
                    </li>
 ...
 <br /><br />
                Notice of alleged infringement must be sent by electronic mail to the Arthanium Copyright Agent at support@Arthanium.com or by certified mail and marked “Copyright Infringement” to Arthanium, D / 303, Silver Gardens, Near Kanti Nagar Ganesh Mandir, J.B. Nagar, Andheri East, Mumbai – 400059, India Attn: IT ACT 2010 AGENT
 <br /><br />
 ...
 <br /><br />
                <strong>TERMINATION OF SERVICE.</strong> We may terminate your right to access secured portions of the Digital Properties at any time, without notice, for conduct that we believe violates these EULA and/or is harmful to other users of the Digital Properties, to us, to our partners, to the contributors, to the business of our Internet service provider, or to other information providers.
 <br /><br />
                <strong>ADDITIONAL REMEDIES.</strong> You acknowledge that your conduct that is inconsistent with the provisions of these EULA may cause us irreparable damage for which remedies other than monetary relief may be inadequate.  In such instances, you agree that we may seek injunctive or other equitable relief seeking to restrain such conduct without the necessity of proving actual harm or posting a bond.
 <br /><br />
                <strong>GOVERNING LAW AND JURISDICTION.</strong> You agree that all matters relating to your access to, or use of, this website shall be governed by the laws of the courts of Mumbai, India. You agree and hereby submit to the exclusive personal jurisdiction and venue of the courts of Mumbai, India, with respect to such matters.
 <br /><br />
                <strong>LOCAL LAWS.</strong> We make no representation that Content or materials on the Digital Properties are appropriate or available for use in jurisdictions outside India.  Access to the Digital Properties from jurisdictions where such access is illegal is prohibited.  If you choose to access the Digital Properties from other jurisdictions, you do so at your own initiative and are responsible for compliance with applicable local laws. We are not responsible for any violation of law.  You may not use or export the Content or materials on the Digital Properties in violation of Indian export laws and regulations.  You agree to comply with all applicable laws regarding the transmission of technical data exported from the India and the country in which you reside (if different from India).
 <br /><br />
                <strong>CUSTOMER COMMENTS.</strong> By submitting comments, information or feedback to us through email and/or the Digital Properties, you agree that the information submitted will be subject to our Privacy Policy located at http://Arthanium.com/privacy-policy/.
 <br /><br />
                <strong> Your Consent To This Agreement</strong>
                <br /><br />
                By accessing and using the Digital Properties, you consent to and agree to be bound by the foregoing EULA. If we decide to change these EULA or some part of them, we will make an effort to post those changes on this web page so that you will always be able to understand and agree to the EULA and conditions governing your use of the Digital Properties.  Your use of the Digital Properties following your acceptance of any amendment of these EULA will signify your assent to and acceptance of its revised EULA for all previously collected information and information collected from you in the future. If you have additional questions or comments of any kind, or if you see anything on the Digital Properties that you think is inappropriate, please let us know by sending your comments or requests to:
 <br /><br />
                Arthanium<br />
                D / 303, Silver Gardens,<br />
                Near Kanti Nagar Ganesh Mandir,<br />
                J.B. Nagar<br />
                Andheri East,<br />
                Mumbai – 400059<br />
                India<br />
                <br /><br />
                Attn: Customer Care – Digital Properties<br />
                info@Arthanium.com
 <br /><br />
                Copyright © 2019. Arthanium.  All Rights Reserved.
 <br /><br />
                Effective as of: August 9, 2019<br />
