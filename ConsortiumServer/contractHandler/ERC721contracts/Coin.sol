...
contract IERC721 is IERC165 {
     ...
     */
    function ownerOf(string memory tokenId) public view returns (address owner);
    ...
    function getApproved(string memory tokenId) public view returns (address operator);

    function setApprovalForAll(address operator, bool _approved) public;
    function isApprovedForAll(address owner, address operator) public view returns (bool);


    function safeTransferFrom(address from, address to, string memory tokenId, bytes memory data) public;
}
...
contract ERC721Pausable is ERC721, Pausable {
    function approve(address to,string memory tokenId) public whenNotPaused {
    ...
    function transferFrom(address from, address to, string memory tokenId) public whenNotPaused {
...
contract ERC721Mintable is ERC721, MinterRole {
     ...
     */
    function mint(address to, string memory tokenId) public onlyMinter returns (bool) {
        _mint(to, tokenId);
        return true;
    }
}
...
contract IERC721Enumerable is IERC721 {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view returns (string memory tokenId);
 ...
 * @dev see https://eips.ethereum.org/EIPS/eip-721
 */
contract ERC721Full is ERC721, ERC721Enumerable, ERC721Metadata, ERC721Mintable, ERC721Burnable, ERC721Pausable, Ownable {
    constructor (string memory name, string memory symbol) public ERC721Metadata(name, symbol) {
        // solhint-disable-previous-line no-empty-blocks
    }


    function setMetadata(string memory tokenId, string memory metadata ) public onlyMinter returns (bool) {
